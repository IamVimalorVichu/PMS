...
import UpvoteButton from './UpvoteButton'; // Adjust path as needed
...
export function PostPreview({ post }: PostPreviewProps) {
  const { user } = useAuth();
  const initialUpvoteCount = post.upvoter_ids?.length ?? 0; // Calculate from array
  ...
  return (
    <div className="border rounded-lg p-4 mb-4 shadow-sm bg-white dark:bg-gray-800 dark:border-gray-700 transition-colors duration-200">
      ...
      {/* Optional Content/Link Previews */}
